/*
 * $Id: dfu.c,v 1.2 2013/11/18 15:13:05 claudio Exp $
 *
 * low-level DFU message sending routines, originally taken from dfu-util
...
{
	if (status > DFU_STATUS_ERROR_STALLEDPKT)
		return "INVALID";
